  ...
  return (
    <div className="">
      <div className="container mx-auto pt-28 pb-16 px-6 md:px-8 md:py-32 space-y-12 md:space-y-24">
        <h1 className="text-2xl md:text-5xl pl-2 md:px-32">Kontakt M Migic</h1>
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-10">
          <div className=" mx-2 md:mx-20">
            <div className="space-y-3 md:space-y-10 text-lg md:text-2xl">
              <a
                href="tel:+38162332476"
              ...
              <a
                href="viber://chat?number=%2B38162332476"
                className="py-[7px] flex border-b-[1px] border-primary"
              >
                <button className="hover:scale-110 transition-transform duration-500 px-4 md:px-8 flex gap-4 items-center">
              ...
              <a
                href="mailto:mtmmigic09@gmail.com"
                className="py-[7px] flex border-b-[1px] border-primary"
              >
                <button className="hover:scale-110 transition-transform duration-500 px-4 md:px-8 flex gap-4 items-center">
                  <Mail className=" w-[28px] h-[28px]" /> mtmmigic09@gmail.com
                </button>
              </a>
              <a
        ...
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d208990.9214257563!2d20.134918615530214!3d44.89495901157043!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x475a5ca302c5b105%3A0x41005875437de415!2sUgrinovackih%20Solunaca%2062%2C%20Ugrinovci!5e0!3m2!1sen!2srs!4v1742343342866!5m2!1sen!2srs"
          width="600"
          height="450"
          style={{ border: "0" }}
          loading="lazy"
